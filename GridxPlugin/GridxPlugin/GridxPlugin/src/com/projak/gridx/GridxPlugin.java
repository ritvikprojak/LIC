 ...
 * <p>
 */
public class GridxPlugin extends Plugin {
	...
	public PluginRequestFilter[] getRequestFilters() {
		return new PluginRequestFilter[]{new DocumentUploadRestrictionRequestFilter()};
	}
//{ new DocumentUploadRestrictionRequestFilter()}
	...
	public String getConfigurationDijitClass() {
		return "gridxPluginDojo.ConfigurationPane";
	}
	...
	public com.ibm.ecm.extension.PluginFeature[] getFeatures() {
		return new com.ibm.ecm.extension.PluginFeature[] {new com.projak.gridx.HLGridxFeature()};
	}
	...
	public com.ibm.ecm.extension.PluginResponseFilter[] getResponseFilters() {
		return new com.ibm.ecm.extension.PluginResponseFilter[] { new com.projak.gridx.HomeLoanViewerFilter() };
	}
	...
	public com.ibm.ecm.extension.PluginService[] getServices() {
		return new com.ibm.ecm.extension.PluginService[] { new com.projak.gridx.HomeLoanDeleteService(),
				new com.projak.gridx.HomeLoanUpdateService(), new com.projak.gridx.HomeLoanUpdateDocumentService(),
				new com.projak.gridx.HomeLoanCompoundDocumentService(),new CheckUserRolePermissionService() };
	}
